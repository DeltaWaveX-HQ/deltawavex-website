...
const testimonials = [
  ...
  },
  {
    name: "Sadhvi",
    role: "Business Lead",
    company: "Retail And Wholesale",
    avatar: "S",
    avatarColor: "from-emerald-500 to-cyan-500",
    text: "DeltaWaveX built our dual-tier billing software on Next.js, Django, and Supabase. The dynamic Retail/Wholesale invoicing, barcode POS checkout, and expense tracking with receipt uploads have completely transformed our operations.",
    rating: 5,
  },
  {
    name: "Raj Kapoor",
    ...
    text: "Inventory Pro transformed how we manage billing across our stores. The dynamic price/margin calculations, barcode scanning, and multi-type invoicing (R1, W1, H1) saved us hours every single day.",
    rating: 5,
  },
  {
    name: "Sneha Patel",
