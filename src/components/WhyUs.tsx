    ...
    <section id="about" className="py-24 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {reasons.map((reason, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-slate-50 border border-slate-200 rounded-2xl p-7 hover:border-slate-300 hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
              >
                {/* Icon with gradient */}
                <div
                ...
                <h3 className="text-slate-900 font-bold text-lg mb-3">{reason.title}</h3>
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-r from-blue-600/5 via-purple-600/5 to-cyan-600/5 border border-slate-200 bg-white rounded-3xl p-8 lg:p-12 shadow-md"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex flex-wrap gap-3">
                {["Product Strategy", "UI/UX Design", "Development", "Deployment", "Maintenance"].map(
                  (item) => (
                    <span
                      key={item}
                      className="px-3 py-1.5 text-sm font-medium text-blue-700 bg-blue-100 border border-blue-200 rounded-lg"
                    >
                      {item}
                    </span>
                  )
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: "3+", label: "Products Launched", color: "text-blue-600" },
                { value: "100%", label: "Custom Built", color: "text-cyan-600" },
