          ...
          <div className="lg:col-span-3 flex flex-col justify-between">
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-4">
                Building products that scale. We are a premium technology studio helping startups and businesses engineer high-performance software systems.
              </p>
              <p className="text-slate-500 text-xs font-mono font-medium mb-6">
